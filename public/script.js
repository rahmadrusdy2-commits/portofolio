...
// KONFIGURASI FIREBASE (Sudah diisi dengan data aslimu)
...
const kontenHalaman = {
    beranda: `
        ...
        <p>Website ini dibangun menggunakan teknik yang unik, yaitu <strong>100% JavaScript</strong> yang terintegrasi dengan autentikasi Google.</p>
    ...
    profil: `
        ...
        <p>Saya adalah seorang pengembang yang bersemangat mempelajari teknologi web modern. Saat ini saya berfokus pada eksplorasi kemampuan JavaScript murni (Vanilla JS).</p>
...
window.loginAdmin = function() {
    signInWithPopup(auth, provider)
        .then((result) => {
            ...
            // GANTI DENGAN EMAIL ASLIMU YANG TERDAFTAR DI FIREBASE
